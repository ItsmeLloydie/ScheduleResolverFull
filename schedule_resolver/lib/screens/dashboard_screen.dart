      ...
      body: Padding(
        ...
        child: Column(
          children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      ElevatedButton(onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const RecommendationScreen())),
            ...
            Expanded(
              child: sortedTasks.isEmpty ? const Center(child: Text('No tasks added yet.'))
                  : ListView.builder(
            ...
            if (sortedTasks.isNotEmpty)
              ElevatedButton(onPressed: aiService.isLoading ? null : () => aiService.analyzeSchedule(scheduleProvider.tasks),
                child: aiService.isLoading ? const CircularProgressIndicator() : const Text('Resolve Conflicts with ryan'),
              ),
          ],
        ),
      ),
